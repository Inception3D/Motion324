...
def get_orthographic_projection_matrix(
    ...
    Args:
        left (float): Left boundary of projection region.
        right (float): Right boundary of projection region.
        bottom (float): Bottom boundary of projection region.
        top (float): Top boundary of projection region.
